...
#
# Created:     04.09.2015
# Modified:    23.09.2016 - tbu: instance name is now beeing considered correctly (i.e.: 'server' or 'server\instance')
#              02.11.2016 - tbu: there was an error if no SQL-GEOMETRY spatial index existed on a table - throwing message for those tables
#
...
# MAIN
-------------------------------------------------------------------------------'''
def main(workspace,dbms_admin_pwd,fc,xmin,ymin,xmax,ymax,l1,l2,l3,l4,cells,defaultextent,compression):
